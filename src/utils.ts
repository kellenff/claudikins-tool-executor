 ...
 *
 * The returned Promise never resolves; after `timeout` milliseconds it rejects
 * with an Error whose message indicates the elapsed timeout in milliseconds.
 * Intended for use as a timeout/race counterpart that bounds the duration of
