...
export const PercentileThroughputCutoffs = Schema.Struct({
  p50: Schema.optionalKey(
    Schema.Number.annotate({ description: "Minimum p50 throughput (tokens/sec)" }).check(
      Schema.isFinite(),
    ),
  ),
  p75: Schema.optionalKey(
    Schema.Number.annotate({ description: "Minimum p75 throughput (tokens/sec)" }).check(
      Schema.isFinite(),
    ),
  ),
  p90: Schema.optionalKey(
    Schema.Number.annotate({ description: "Minimum p90 throughput (tokens/sec)" }).check(
      Schema.isFinite(),
    ),
  ),
  p99: Schema.optionalKey(
    Schema.Number.annotate({ description: "Minimum p99 throughput (tokens/sec)" }).check(
      Schema.isFinite(),
    ),
  ),
}).annotate({
...
export const PercentileLatencyCutoffs = Schema.Struct({
  p50: Schema.optionalKey(
    Schema.Number.annotate({ description: "Maximum p50 latency (seconds)" }).check(
      Schema.isFinite(),
    ),
  ),
  p75: Schema.optionalKey(
    Schema.Number.annotate({ description: "Maximum p75 latency (seconds)" }).check(
      Schema.isFinite(),
    ),
  ),
  p90: Schema.optionalKey(
    Schema.Number.annotate({ description: "Maximum p90 latency (seconds)" }).check(
      Schema.isFinite(),
    ),
  ),
  p99: Schema.optionalKey(
    Schema.Number.annotate({ description: "Maximum p99 latency (seconds)" }).check(
      Schema.isFinite(),
    ),
  ),
}).annotate({
...
export const ActivityItem = Schema.Struct({
  ...
  requests: Schema.Number.annotate({ description: "Number of requests made" }).check(
    Schema.isFinite(),
  ),
  prompt_tokens: Schema.Number.annotate({ description: "Total prompt tokens used" }).check(
    Schema.isFinite(),
  ),
  completion_tokens: Schema.Number.annotate({
    description: "Total completion tokens generated",
  }).check(Schema.isFinite()),
  reasoning_tokens: Schema.Number.annotate({ description: "Total reasoning tokens used" }).check(
    Schema.isFinite(),
  ),
});
...
export const TopProviderInfo = Schema.Struct({
  context_length: Schema.optionalKey(
    Schema.Number.annotate({ description: "Context length from the top provider" }).check(
      Schema.isFinite(),
    ),
  ),
...
export const ModelsCountResponse = Schema.Struct({
  data: Schema.Struct({
    count: Schema.Number.annotate({ description: "Total number of available models" }).check(
      Schema.isFinite(),
    ),
...
export const OpenResponsesWebSearchTool = Schema.Struct({
  ...
  filters: Schema.optionalKey(
    Schema.Struct({ allowed_domains: Schema.optionalKey(Schema.Array(Schema.String)) }),
  ),
  search_context_size: Schema.optionalKey(ResponsesSearchContextSize),
...
export const PublicEndpoint = Schema.Struct({
  ...
  throughput_last_30m: Schema.Struct({
    p50: Schema.Number.annotate({ description: "Median (50th percentile)" }).check(
      Schema.isFinite(),
    ),
    p75: Schema.Number.annotate({ description: "75th percentile" }).check(Schema.isFinite()),
    p90: Schema.Number.annotate({ description: "90th percentile" }).check(Schema.isFinite()),
...
export const ChatGenerationParams = Schema.Struct({
        ...
        [
          ...
          Schema.Struct({
            ...
            pdf: Schema.optionalKey(
              Schema.Struct({
                engine: Schema.optionalKey(Schema.Literals(["mistral-ocr", "pdf-text", "native"])),
              }),
            ),
          }),
          Schema.Struct({
  ...
  reasoning: Schema.optionalKey(
    Schema.Struct({
      effort: Schema.optionalKey(
        Schema.Union([
          Schema.Literals(["xhigh", "high", "medium", "low", "minimal", "none"]),
          Schema.Null,
        ]),
      ),
  ...
  stop: Schema.optionalKey(
    Schema.Union([
      Schema.Union([Schema.String, Schema.Array(ModelName).check(Schema.isMaxLength(4))]),
      Schema.Null,
    ]),
  ),
  stream: Schema.optionalKey(Schema.Boolean),
...
export type GetCredits200 = {
  readonly data: { readonly total_credits: number; readonly total_usage: number };
};
export const GetCredits200 = Schema.Struct({
  data: Schema.Struct({
    total_credits: Schema.Number.annotate({ description: "Total credits purchased" }).check(
      Schema.isFinite(),
    ),
    total_usage: Schema.Number.annotate({ description: "Total credits used" }).check(
      Schema.isFinite(),
    ),
  }),
...
export const GetGeneration200 = Schema.Struct({
  data: Schema.Struct({
    ...
    app_id: Schema.Number.annotate({ description: "ID of the app that made the request" }).check(
      Schema.isFinite(),
    ),
    ...
    latency: Schema.Number.annotate({ description: "Total latency in milliseconds" }).check(
      Schema.isFinite(),
    ),
...
export const ListParams = Schema.Struct({
  ...
  offset: Schema.optionalKey(
    Schema.String.annotate({ description: "Number of API keys to skip for pagination" }),
  ),
});
export type List200 = {
  readonly data: ReadonlyArray<{
...
export const CreateKeysRequestJson = Schema.Struct({
  name: Schema.String.annotate({ description: "Name for the new API key" }).check(
    Schema.isMinLength(1),
  ),
  limit: Schema.optionalKey(
    Schema.Number.annotate({ description: "Optional spending limit for the API key in USD" }).check(
      Schema.isFinite(),
    ),
  ),
...
export const UpdateKeysRequestJson = Schema.Struct({
  ...
  limit: Schema.optionalKey(
    Schema.Number.annotate({ description: "New spending limit for the API key in USD" }).check(
      Schema.isFinite(),
    ),
  ),
  limit_reset: Schema.optionalKey(
...
export const ListGuardrailsParams = Schema.Struct({
  offset: Schema.optionalKey(
    Schema.String.annotate({ description: "Number of records to skip for pagination" }),
  ),
  limit: Schema.optionalKey(
...
export const ListGuardrails200 = Schema.Struct({
  ...
  total_count: Schema.Number.annotate({ description: "Total number of guardrails" }).check(
    Schema.isFinite(),
  ),
});
...
export const CreateGuardrailRequestJson = Schema.Struct({
  ...
  description: Schema.optionalKey(
    Schema.String.annotate({ description: "Description of the guardrail" }).check(
...
export const UpdateGuardrailRequestJson = Schema.Struct({
  ...
  description: Schema.optionalKey(
    Schema.String.annotate({ description: "New description for the guardrail" }).check(
      Schema.isMaxLength(1000),
    ),
  ),
  limit_usd: Schema.optionalKey(
...
export const CreateAuthKeysCodeRequestJson = Schema.Struct({
  ...
  limit: Schema.optionalKey(
    Schema.Number.annotate({ description: "Credit limit for the API key to be created" }).check(
      Schema.isFinite(),
    ),
  ),
  expires_at: Schema.optionalKey(
...
export interface OperationConfig {
  /**
   * Whether or not the response should be included in the value returned from an operation.
   *
   * If set to `true`, a tuple of `[A, HttpClientResponse]` will be returned, where `A` is the
   * success type of the operation.
   *
...
/**
 * A utility type which optionally includes the response in the return result of an operation based
 * upon the value of the `includeResponse` configuration option.
 */
...
export interface OpenRouterClient {
  ...
  >;
  /**
   * Creates a message using the Anthropic Messages API format. Supports text, images, PDFs, tools,
  ...
  >;
  /**
   * Get a single API key by hash. [Management key](/docs/guides/overview/auth/management-api-keys)
   * required.
   */
  ...
  >;
  /**
   * Delete an existing API key. [Management key](/docs/guides/overview/auth/management-api-keys)
   * required.
   */
  ...
  >;
  /**
   * Update an existing API key. [Management key](/docs/guides/overview/auth/management-api-keys)
   * required.
   */
  ...
  >;
  /**
   * Get a single guardrail by ID. [Management key](/docs/guides/overview/auth/management-api-keys)
   * required.
   */
  ...
  >;
  /**
   * Delete an existing guardrail. [Management key](/docs/guides/overview/auth/management-api-keys)
   * required.
   */
  ...
  >;
  /**
   * Update an existing guardrail. [Management key](/docs/guides/overview/auth/management-api-keys)
   * required.
   */
  ...
  >;
  /**
   * Sends a request for a model response for the given chat conversation. Supports both streaming
