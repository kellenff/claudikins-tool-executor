...
export const BetaRequestTextEditorCodeExecutionStrReplaceResultBlock = Schema.Struct({
  lines: Schema.optionalKey(
    Schema.Union([Schema.Array(Schema.String), Schema.Null]).annotate({ title: "Lines" }),
  ),
...
export const BetaResponseWebSearchResultLocationCitation = Schema.Struct({
  cited_text: Schema.String.annotate({ title: "Cited Text" }),
  encrypted_index: Schema.String.annotate({ title: "Encrypted Index" }),
  title: Schema.Union([Schema.String.check(Schema.isMaxLength(512)), Schema.Null]).annotate({
    title: "Title",
  }),
...
export const BetaTool = Schema.Struct({
  type: Schema.optionalKey(
    Schema.Union([Schema.Null, Schema.Literal("custom")]).annotate({ title: "Type" }),
  ),
...
export const BetaResponseDocumentBlock = Schema.Struct({
  ...
  source: Schema.Union([BetaBase64PDFSource, BetaPlainTextSource], { mode: "oneOf" }).annotate({
    title: "Source",
  }),
...
export type BetaResponseContextManagement = {
  readonly applied_edits: ReadonlyArray<
    BetaResponseClearToolUses20250919Edit | BetaResponseClearThinking20251015Edit
  >;
};
export const BetaResponseContextManagement = Schema.Struct({
  applied_edits: Schema.Array(
    Schema.Union([BetaResponseClearToolUses20250919Edit, BetaResponseClearThinking20251015Edit], {
      mode: "oneOf",
    }),
  ).annotate({
    title: "Applied Edits",
...
export const ResponseDocumentBlock = Schema.Struct({
  ...
  source: Schema.Union([Base64PDFSource, PlainTextSource], { mode: "oneOf" }).annotate({
    title: "Source",
  }),
  title: Schema.Union([Schema.String, Schema.Null]).annotate({
    title: "Title",
...
export const RequestImageBlock = Schema.Struct({
  ...
  source: Schema.Union([Base64ImageSource, URLImageSource], { mode: "oneOf" }).annotate({
    title: "Source",
  }),
  type: Schema.Literal("image").annotate({ title: "Type" }),
}).annotate({ title: "RequestImageBlock" });
...
export const BetaContextManagementConfig = Schema.Struct({
  edits: Schema.optionalKey(
    Schema.Array(
      Schema.Union([BetaClearToolUses20250919, BetaClearThinking20251015, BetaCompact20260112], {
        mode: "oneOf",
      }),
    )
...
export const BetaRequestDocumentBlock = Schema.Struct({
  ...
  context: Schema.optionalKey(
    Schema.Union([Schema.String.check(Schema.isMinLength(1)), Schema.Null]).annotate({
      title: "Context",
    }),
  ),
  source: Schema.Union(
...
export interface AnthropicClient {
   ...
   * API](https://docs.claude.com/en/api/messages) going forward.
   *
   * Future models and features will not be compatible with Text Completions. See our [migration
   * guide](https://docs.claude.com/en/api/migrating-from-text-completions-to-messages) for guidance
   * in migrating from Text Completions to Messages.
   */
   ...
   *
   * The Models API response can be used to determine information about a specific model or resolve
   * a model alias to a model ID.
   */
   ...
   *
   * Learn more about the Message Batches API in our [user
   * guide](https://docs.claude.com/en/docs/build-with-claude/batch-processing)
   */
   ...
   * Batch. Results are not guaranteed to be in the same order as requests. Use the `custom_id`
   ...
   *
   * Learn more about token counting in our [user
   * guide](https://docs.claude.com/en/docs/build-with-claude/token-counting)
   */
