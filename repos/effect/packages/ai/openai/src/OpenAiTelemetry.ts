/**
 * The `OpenAiTelemetry` module defines OpenAI-specific telemetry attributes and a helper for adding
 * them to a tracing span. It keeps the standard GenAI telemetry attributes and adds request and
 * response metadata, such as response format, service tier, and system fingerprint, under the
...
/**
 * The `gen_ai.openai.request.response_format` attribute has the following list of well-known
 * values.
 *
 * **Details**
 *
 ...
 * optional OpenAI request and response attributes.
 *
 * @since 4.0.0
 * @category Options
 */
 ...
 * **When to use**
 *
 * Use to annotate an existing OpenTelemetry span with standard GenAI attributes plus
 * OpenAI-specific request and response metadata.
 *
 * **Gotchas**
 *
