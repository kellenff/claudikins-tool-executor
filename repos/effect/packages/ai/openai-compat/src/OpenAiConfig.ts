 ...
 * OpenAI-compatible request helpers. Model, embedding, and tool-calling code can use this scoped
 * configuration to add middleware, instrumentation, or routing without rebuilding the client
 * layer.
 *
 * @since 4.0.0
 */
 ...
 * **When to use**
 *
 * Use as the context service for scoped OpenAI-compatible client configuration and HTTP client
 * transforms.
 *
 * @since 4.0.0
 * @category Services
...
export declare namespace OpenAiConfig {
  /**
   * Configuration consumed by OpenAI-compatible clients when they build or resolve the underlying
   * HTTP client.
   *
   * @since 4.0.0
   * @category Models
 ...
 * **When to use**
 *
 * Use to add provider-specific OpenAI-compatible HTTP behavior, such as headers, retries,
 * instrumentation, or proxy routing.
 *
 * **Details**
 *
