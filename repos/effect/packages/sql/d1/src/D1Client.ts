 ...
 * and the generic Effect `SqlClient` service. It uses the SQLite statement compiler, caches
 * prepared statements, maps D1 failures to `SqlError`, and provides direct or config-backed layers.
 * Transactions, streaming queries, and `updateValues` are not supported by this driver.
 *
 * @since 4.0.0
 */
...
/**
 * Cloudflare D1 SQL client service, extending `SqlClient` with its D1 configuration and no
 * `updateValues` support.
 *
 * @since 4.0.0
 * @category Models
 */
...
/**
 * Configuration for a Cloudflare D1 client, including the `D1Database`, prepared statement cache
 * settings, span attributes, and query/result name transforms.
 *
 * @since 4.0.0
 * @category Models
 */
...
/**
 * Creates a scoped Cloudflare D1 SQL client. Prepared statements are cached, while transactions and
 * streaming queries are not supported by this driver.
 *
 * @since 4.0.0
...
/**
 * Creates a layer from a `Config`-wrapped D1 client configuration, providing both `D1Client` and
 * `SqlClient`.
 *
 * @since 4.0.0
 * @category Layers
...
/**
 * Creates a layer from a concrete D1 client configuration, providing both `D1Client` and
 * `SqlClient`.
 *
 * @since 4.0.0
 * @category Layers
