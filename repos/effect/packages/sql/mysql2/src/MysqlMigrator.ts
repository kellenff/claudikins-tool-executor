 ...
 * `layer` helpers that apply ordered migrations through the current mysql2-backed `SqlClient`.
 * `run` returns the applied migration IDs and names, while `layer` runs migrations during layer
