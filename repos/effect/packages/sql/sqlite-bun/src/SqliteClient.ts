 ...
 * SQL client. It serializes access to the database, enables WAL mode unless disabled, and supports
 * database export and extension loading. Streaming queries and `updateValues` are not supported by
 * this driver.
 *
 * @since 4.0.0
 */
...
/**
 * Bun SQLite client service, extending `SqlClient` with database export and extension loading
 * helpers. `updateValues` is not supported.
 *
 * @since 4.0.0
 * @category Models
 */
...
/**
 * Configuration for a Bun SQLite client, including filename, open mode flags, WAL behavior, span
...
/**
 * Creates a scoped Bun SQLite client for a database file, enabling WAL by default and serializing
 * access. Streaming queries are not implemented.
 *
 * @since 4.0.0
...
/**
 * Creates a layer from a `Config`-wrapped Bun SQLite client configuration, providing both
...
/**
 * Creates a layer from a concrete Bun SQLite client configuration, providing both `SqliteClient`
 * and `SqlClient`.
 *
 * @since 4.0.0
 * @category Layers
