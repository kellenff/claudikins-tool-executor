 ...
 *
 * The main `layer` builds a sharding layer for HTTP or WebSocket transport, choosing serialization,
 * runner health checks, runner storage, message storage, and optional client-only mode from the
 * supplied options. `layerHttpServer` provides the Node HTTP server used by cluster runners, and
 * this module re-exports the Kubernetes HTTP client layer used by runner health checks.
 *
 * @since 4.0.0
 */
...
/**
 * Builds the Node cluster HTTP/WebSocket sharding layer, configuring runner transport, RPC
 * serialization, message storage, runner health checks, and optional client-only mode.
 *
 * @since 4.0.0
 * @category Layers
 */
...
/**
 * Provides the HTTP server and Node HTTP services used by cluster runners, listening on
