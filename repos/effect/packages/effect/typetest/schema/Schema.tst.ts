...
describe("Schema", () => {
  describe("variance", () => {
    it("Type", () => {
      const f1 =
        hole<<A extends string, S extends Schema.Codec<A, unknown, unknown>>(schema: S) => S>();
    ...
    it("Encoded", () => {
      const f1 =
        hole<<A extends number, S extends Schema.Codec<unknown, A, unknown>>(schema: S) => S>();
  ...
  describe("toCodecJson", () => {
    ...
    it("revealCodec + annotate", () => {
      const schema = Schema.toCodecJson(Schema.FiniteFromString);
      expect(Schema.revealCodec(schema)).type.toBe<
        Schema.Codec<number, Schema.Json, never, never>
      >();
  ...
  describe("toCodecStringTree", () => {
    ...
    it("revealCodec + annotate", () => {
      const schema = Schema.toCodecStringTree(Schema.FiniteFromString);
      expect(Schema.revealCodec(schema)).type.toBe<
        Schema.Codec<number, Schema.StringTree, never, never>
      >();
  ...
  it("TemplateLiteral", () => {
    ...
    expect(
      Schema.TemplateLiteral([Schema.Literal("a"), Schema.Literal("b")])["Encoded"],
    ).type.toBe<`ab`>();
    ...
    >();
    expect(
      Schema.TemplateLiteral(["a", Schema.Union([Schema.Number, Schema.String])])["Encoded"],
  ...
  it("TemplateLiteralParser", () => {
    ...
    >();
    expect(
      Schema.revealCodec(Schema.TemplateLiteralParser([Schema.Literal("a"), Schema.Literal("b")])),
    ...
    >();
    expect(
      Schema.revealCodec(Schema.TemplateLiteralParser([Schema.Literal("a"), Schema.String])),
    ...
    >();
    expect(
      Schema.revealCodec(Schema.TemplateLiteralParser([Schema.Literal("a"), Schema.Number])),
    ...
    >();
    expect(
      Schema.revealCodec(Schema.TemplateLiteralParser([Schema.String, Schema.Literal("a")])),
    ...
    >();
    expect(
      Schema.revealCodec(Schema.TemplateLiteralParser([Schema.Number, Schema.Literal("a")])),
    ...
    >();
    expect(
      Schema.revealCodec(Schema.TemplateLiteralParser([Schema.String, Schema.Literals(["a", 0])])),
    ).type.toBe<Schema.Codec<readonly [string, 0 | "a"], `${string}a` | `${string}0`>>();
    expect(
      Schema.revealCodec(
        Schema.TemplateLiteralParser([Schema.String, Schema.Literal("/"), Schema.Number]),
      ),
    ).type.toBe<Schema.Codec<readonly [string, "/", number], `${string}/${number}`>>();
    expect(
      Schema.revealCodec(Schema.TemplateLiteralParser([Schema.String, "/", Schema.Number])),
    ).type.toBe<Schema.Codec<readonly [string, "/", number], `${string}/${number}`>>();
    const EmailLocaleIDs = Schema.Literals(["welcome_email", "email_heading"]);
    const FooterLocaleIDs = Schema.Literals(["footer_title", "footer_sendoff"]);
    expect(
    ...
    expect(
      Schema.revealCodec(
        Schema.TemplateLiteralParser([Schema.Union([EmailLocaleIDs, FooterLocaleIDs]), "_id"]),
      ),
    ).type.toBe<
      Schema.Codec<
        readonly ["welcome_email" | "email_heading" | "footer_title" | "footer_sendoff", "_id"],
    ...
    expect(
      Schema.revealCodec(
        Schema.TemplateLiteralParser([Schema.String.pipe(Schema.brand("MyBrand"))]),
      ),
    ).type.toBe<Schema.Codec<readonly [string & Brand.Brand<"MyBrand">], string>>();
    expect(
      Schema.revealCodec(
        Schema.TemplateLiteralParser([Schema.Number.pipe(Schema.brand("MyBrand"))]),
      ),
    ).type.toBe<Schema.Codec<readonly [number & Brand.Brand<"MyBrand">], `${number}`>>();
    expect(
      Schema.revealCodec(
        Schema.TemplateLiteralParser(["a", Schema.String.pipe(Schema.brand("MyBrand"))]),
      ),
    ...
    expect(
      Schema.revealCodec(
        Schema.TemplateLiteralParser(["a", Schema.Number.pipe(Schema.brand("MyBrand"))]),
      ),
    ...
    expect(
      Schema.revealCodec(
        Schema.TemplateLiteralParser(["a", Schema.Union([Schema.Number, Schema.String])]),
      ),
  ...
  describe("passthrough", () => {
    ...
    it("E != T", () => {
      ...
      Schema.String.pipe(
        Schema.decodeTo(Schema.Number, SchemaTransformation.passthrough({ strict: false })),
      );
    });
  ...
  describe("Class APIs", () => {
    describe("Class", () => {
      ...
      it("branded (unique symbol)", () => {
        ...
        class ABranded extends Schema.Class<ABranded, { readonly brand: unique symbol }>(
          "ABranded",
        )({
          a: Schema.String,
        }) {}
        class BBranded extends Schema.Class<BBranded, { readonly brand: unique symbol }>(
          "BBranded",
        )({
          a: Schema.String,
        }) {}
      ...
      it("extend Struct argument", () => {
        ...
        expect(Schema.revealCodec(B)).type.toBe<
          Schema.Codec<B, { readonly a: string; readonly b: number }>
        >();
  ...
  it("withDecodingDefaultKey", () => {
    ...
    expect(schema).type.toBe<
      Schema.Struct<{ readonly a: Schema.withDecodingDefaultKey<Schema.FiniteFromString> }>
    >();
    expect(Schema.revealCodec(schema)).type.toBe<
  ...
  it("withDecodingDefault", () => {
    ...
    expect(schema).type.toBe<
      Schema.Struct<{ readonly a: Schema.withDecodingDefault<Schema.FiniteFromString> }>
    >();
    expect(Schema.revealCodec(schema)).type.toBe<
  ...
  describe("OptionFrom", () => {
    it("preserves concrete wrapper types", () => {
      ...
      expect(nullOr.annotate({})).type.toBe<
        Schema.OptionFromNullOr<typeof Schema.FiniteFromString>
      >();
      ...
      expect(undefinedOr.annotate({})).type.toBe<
        Schema.OptionFromUndefinedOr<typeof Schema.FiniteFromString>
      >();
      ...
      expect(nullishOr.annotate({})).type.toBe<
        Schema.OptionFromNullishOr<typeof Schema.FiniteFromString>
      >();
      ...
      expect(optionalKey.annotate({})).type.toBe<
        Schema.OptionFromOptionalKey<typeof Schema.FiniteFromString>
      >();
      ...
      expect(optional.annotate({})).type.toBe<
        Schema.OptionFromOptional<typeof Schema.FiniteFromString>
      >();

      const optionalNullOr = Schema.OptionFromOptionalNullOr(Schema.FiniteFromString);
      expect(optionalNullOr).type.toBe<
        Schema.OptionFromOptionalNullOr<typeof Schema.FiniteFromString>
      >();
      expect(optionalNullOr.annotate({})).type.toBe<
        Schema.OptionFromOptionalNullOr<typeof Schema.FiniteFromString>
      >();
    });
  });
