...
describe("Union", () => {
  ...
  describe("mapMembers", () => {
    ...
    it("evolve", () => {
      ...
      expect(schema).type.toBe<
        Schema.Union<
          readonly [Schema.$Array<Schema.String>, Schema.Number, Schema.$Array<Schema.Boolean>]
        >
      >();
    });
    ...
    it("Array", () => {
      ...
      >();
      expect(schema).type.toBe<
        Schema.Union<readonly [Schema.$Array<Schema.String>, Schema.$Array<Schema.Number>]>
      >();
    });
    ...
    it("NonEmptyArray", () => {
      ...
      expect(schema).type.toBe<
        Schema.Union<
          readonly [Schema.NonEmptyArray<Schema.String>, Schema.NonEmptyArray<Schema.Number>]
        >
      >();
    });
  });
  ...
  describe("Tagged unions", () => {
    describe("asTaggedUnion", () => {
      ...
      it("isAnyOf should narrow custom tags", () => {
        ...
        if (schema.isAnyOf(["a", "b"])(value)) {
          expect(value).type.toBe<
            { readonly kind: "a"; readonly a: number } | { readonly kind: "b"; readonly b: string }
          >();
        }
      });
      ...
      it("should flatten discriminants", () => {
        ...
        expect(Schema.Literals(schema.discriminants)).type.toBe<
