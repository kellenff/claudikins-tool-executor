...
describe("Array", () => {
  ...
  it("filter", () => {
    ...
    expect(Array.filter).type.not.toBeCallableWith(numbersOrStrings, (_item: string | number) =>
  ...
  it("liftPredicate", () => {
    ...
    expect(pipe(primitiveNumberOrString, Array.liftPredicate(Predicate.isString))).type.toBe<
      Array<string>
    >();
  ...
  it("separate", () => {
    ...
    expect(Array.separate([Result.fail("a"), Result.succeed(1)])).type.toBe<
      [Array<string>, Array<number>]
    >();
    expect(Array.separate(hole<Array<Result.Result<number, string>>>())).type.toBe<
      [Array<string>, Array<number>]
    >();
    expect(Array.separate(hole<Iterable<Result.Result<number, string>>>())).type.toBe<
      [Array<string>, Array<number>]
    >();
    expect(
      Array.separate(
  ...
  it("getSuccesses", () => {
    ...
    expect(Array.getSuccesses(hole<Array<Result.Result<number, string>>>())).type.toBe<
      Array<number>
    >();
    expect(Array.getSuccesses(hole<Iterable<Result.Result<number, string>>>())).type.toBe<
      Array<number>
    >();
    expect(
      Array.getSuccesses(
  ...
  it("getFailures", () => {
    ...
    expect(Array.getFailures(hole<Array<Result.Result<number, string>>>())).type.toBe<
      Array<string>
    >();
    expect(Array.getFailures(hole<Iterable<Result.Result<number, string>>>())).type.toBe<
      Array<string>
    >();
    expect(
      Array.getFailures(
