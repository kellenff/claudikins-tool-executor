  ...
  describe("apply", () => {
    describe("happy paths", () => {
      ...
      it("replace", () => {
        ...
        deepStrictEqual(JsonPatch.apply([{ op: "replace", path: "/a", value: 2 }], { a: 1 }), {
          a: 2,
        });
      ...
      it("add", () => {
        deepStrictEqual(JsonPatch.apply([{ op: "add", path: "/b", value: 2 }], { a: 1 }), {
          a: 1,
          b: 2,
        });
      ...
      it("remove", () => {
        ...
        deepStrictEqual(JsonPatch.apply([{ op: "remove", path: "/a/b" }], { a: { b: 1, c: 2 } }), {
          a: { c: 2 },
        });
      });
    ...
    describe("JSON Pointer decoding", () => {
      it("decodes '~1' as '/' and '~0' as '~'", () => {
        ...
        deepStrictEqual(JsonPatch.apply([{ op: "add", path: "/a~0b", value: 1 }], {}), {
          "a~b": 1,
        });
      ...
      it("decodes '~01' as a literal '~1' (unescape order)", () => {
        deepStrictEqual(JsonPatch.apply([{ op: "add", path: "/a~01b", value: 1 }], {}), {
          "a~1b": 1,
        });
      });
    ...
    describe("edge cases", () => {
      ...
      it("handles operations on empty objects", () => {
        deepStrictEqual(JsonPatch.apply([{ op: "add", path: "/key", value: "value" }], {}), {
          key: "value",
        });
      });
