 ...
 *
 * Converts a 2D ASCII grid into a directed graph where each walkable cell becomes a node, and edges
 * connect adjacent walkable cells with weights based on terrain type.
 */
