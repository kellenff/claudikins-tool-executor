            ...
            indexSignatures: [
              ...
              },
              {
                parameter: {
                  _tag: "String",
                  checks: [
                    { _tag: "Filter", meta: { _tag: "isPattern", regExp: new RegExp("b*") } },
                  ],
                },
          ...
          },
          {
            representation: {
              ...
              checks: [
                {
                  _tag: "Filter",
                  meta: { _tag: "isPropertyNames", propertyNames: { _tag: "Never" } },
                },
              ],
            },
          },
  ...
  describe("allOf", () => {
    ...
    describe("literal refinements", () => {
      ...
      > = [
        ...
        [
          "multipleOf with a large scientific operand",
