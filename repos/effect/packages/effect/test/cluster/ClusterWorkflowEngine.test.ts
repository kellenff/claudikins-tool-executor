  ...
  it.effect(
    ...
    () =>
      Effect.gen(function* () {
        ...
        const executionIdBeforeRegister = yield* ShardedDeferredWorkflow.executionId({
          id: "before-register",
        });
        ...
        const executionIdAfterRegister = yield* ShardedDeferredWorkflow.executionId({
          id: "after-register",
        });
...
const ErrorDefectWorkflowLayer = ErrorDefectWorkflow.toLayer(
  Effect.fnUntraced(function* () {
    yield* Activity.make({
