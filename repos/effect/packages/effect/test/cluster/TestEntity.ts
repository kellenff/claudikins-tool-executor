...
export const CallerId = Context.Service<never, string>("effect/test/cluster/CallerId");
...
export const ContextBleedEntity = Entity.make("ContextBleedEntity", [
  ...
  Rpc.make("ReadCallerPersisted", { success: Schema.String }).annotate(
