 ...
 *
 * Message AnyValue { oneof value { string string_value = 1; bool bool_value = 2; int64 int_value =
 * 3; double double_value = 4; ArrayValue array_value = 5; KeyValueList kvlist_value = 6; bytes
 * bytes_value = 7; } }
 *
 * @internal
 */
 ...
 *
 * Message InstrumentationScope { string name = 1; string version = 2; repeated KeyValue attributes
 * = 3; uint32 dropped_attributes_count = 4; }
 *
 * @internal
 */
 ...
 *
 * Message Link { bytes trace_id = 1; bytes span_id = 2; string trace_state = 3; repeated KeyValue
 * attributes = 4; uint32 dropped_attributes_count = 5; fixed32 flags = 6; }
 *
 * @internal
 */
 ...
 *
 * Message Span { bytes trace_id = 1; bytes span_id = 2; string trace_state = 3; bytes
 * parent_span_id = 4; string name = 5; SpanKind kind = 6; fixed64 start_time_unix_nano = 7; fixed64
 * end_time_unix_nano = 8; repeated KeyValue attributes = 9; uint32 dropped_attributes_count = 10;
 * repeated Event events = 11; uint32 dropped_events_count = 12; repeated Link links = 13; uint32
 * dropped_links_count = 14; Status status = 15; fixed32 flags = 16; }
 *
 * @internal
 */
 ...
 *
 * Message ScopeSpans { InstrumentationScope scope = 1; repeated Span spans = 2; string schema_url =
 * 3; }
 *
 * @internal
 */
 ...
 *
 * Message ResourceSpans { Resource resource = 1; repeated ScopeSpans scope_spans = 2; string
 * schema_url = 3; }
 *
 * @internal
 */
 ...
 *
 * Message NumberDataPoint { repeated KeyValue attributes = 7; fixed64 start_time_unix_nano = 2;
 * fixed64 time_unix_nano = 3; oneof value { double as_double = 4; sfixed64 as_int = 6; } repeated
 * Exemplar exemplars = 5; uint32 flags = 8; }
 *
 * @internal
 */
 ...
 *
 * Message HistogramDataPoint { repeated KeyValue attributes = 9; fixed64 start_time_unix_nano = 2;
 * fixed64 time_unix_nano = 3; fixed64 count = 4; optional double sum = 5; repeated fixed64
 * bucket_counts = 6; repeated double explicit_bounds = 7; optional double min = 11; optional double
 * max = 12; uint32 flags = 10; }
 *
 * @internal
 */
 ...
 *
 * Message Sum { repeated NumberDataPoint data_points = 1; AggregationTemporality
 * aggregation_temporality = 2; bool is_monotonic = 3; }
 *
 * @internal
 */
 ...
 *
 * Message Histogram { repeated HistogramDataPoint data_points = 1; AggregationTemporality
 ...
 *
 * Message Metric { string name = 1; string description = 2; string unit = 3; oneof data { Gauge
 * gauge = 5; Sum sum = 7; Histogram histogram = 9; ExponentialHistogram exponential_histogram = 10;
 * Summary summary = 11; } }
 *
 * @internal
 */
 ...
 *
 * Message ScopeMetrics { InstrumentationScope scope = 1; repeated Metric metrics = 2; string
 * schema_url = 3; }
 *
 * @internal
 */
 ...
 *
 * Message ResourceMetrics { Resource resource = 1; repeated ScopeMetrics scope_metrics = 2; string
 * schema_url = 3; }
 *
 * @internal
 */
 ...
 *
 * Message LogRecord { fixed64 time_unix_nano = 1; fixed64 observed_time_unix_nano = 11;
 * SeverityNumber severity_number = 2; string severity_text = 3; AnyValue body = 5; repeated
 * KeyValue attributes = 6; uint32 dropped_attributes_count = 7; fixed32 flags = 8; bytes trace_id =
 * 9; bytes span_id = 10; }
 *
 * @internal
 */
 ...
 *
 * Message ScopeLogs { InstrumentationScope scope = 1; repeated LogRecord log_records = 2; string
 * schema_url = 3; }
 *
 * @internal
 */
 ...
 *
 * Message ResourceLogs { Resource resource = 1; repeated ScopeLogs scope_logs = 2; string
 * schema_url = 3; }
 *
 * @internal
 */
