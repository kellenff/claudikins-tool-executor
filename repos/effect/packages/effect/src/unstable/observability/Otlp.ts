 ...
 *
 * This module installs the OTLP logger, metrics exporter, and tracer exporter from one shared
 * configuration. Use it when an application sends logs, metrics, and traces to the same
 * OpenTelemetry Collector, vendor OTLP endpoint, or local development collector.
 *
 * @since 4.0.0
 */
 ...
 * **Details**
 *
 * The layer sends data to `/v1/logs`, `/v1/metrics`, and `/v1/traces` below `baseUrl` and requires
 * an `OtlpSerialization` implementation.
 *
 * @since 4.0.0
 * @category Layers
 */
