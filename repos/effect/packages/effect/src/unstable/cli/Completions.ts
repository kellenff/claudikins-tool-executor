/**
 * The `Completions` module turns a plain description of an Effect CLI command tree into shell
 * completion scripts for Bash, Zsh, and Fish. It is the low-level script generation surface used by
 * the unstable CLI package and by the built-in completions global flag.
 *
 * @since 4.0.0
 */
 ...
 * **Details**
 *
 * Dispatches by `shell` to Bash, Zsh, or Fish generation and returns a static script string for
 * `executableName`.
 *
 * @since 4.0.0
