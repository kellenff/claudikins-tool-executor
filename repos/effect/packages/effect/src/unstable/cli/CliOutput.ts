 ...
 *
 * This module turns help documents, CLI errors, grouped errors, and version information into
 * strings. It does not write those strings to the terminal itself. It includes the `Formatter`
 * interface, the formatter service, a layer for custom formatters, and the default formatter with
...
/**
 * Service reference for the CLI output formatter. Provides a default implementation that can be
 * overridden for custom formatting or testing.
 *
