...
/**
 * Build an associative array mapping each flag form to a group index. At completion time, if any
 * form in a group appears in COMP_WORDS, all forms in that group are removed from the candidate
 * list.
 */
