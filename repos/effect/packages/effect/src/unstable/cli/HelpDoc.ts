/**
 * Structured help documentation model for the unstable CLI package. A `HelpDoc` value captures the
 * user-facing parts of a command, including its description, usage string, positional arguments,
 * flags, global flags, subcommands, annotations, and examples.
 *
 * This module only defines the data shapes used to describe help. Rendering that data as terminal
 * text is handled by `CliOutput`.
 *
 * @since 4.0.0
 */
...
/**
 * Structured representation of help documentation for a command. This data structure is independent
 * of formatting, allowing for different output formats (text, markdown, JSON, etc.).
 *
...
export interface HelpDoc {
  ...
  /** Usage syntax showing how to invoke the command Example: "myapp deploy [flags]" */
...
export interface SubcommandGroupDoc {
  /** Group name used in help output. Undefined means the default ungrouped section. */
