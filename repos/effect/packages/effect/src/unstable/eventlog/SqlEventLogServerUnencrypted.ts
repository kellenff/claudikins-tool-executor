 ...
 * when remote entries should be stored in a SQL database and streamed back to clients by store
 * sequence. It creates dialect-specific tables for the server remote id, per-store sequence state,
 ...
 * **Details**
 *
 * The implementation creates tables for the server remote id, store sequences, entries, and session
 * authentication bindings, then persists and streams plaintext remote entries.
 *
 * @since 4.0.0
