 ...
 *
 * This module provides reusable `Schema.ErrorClass` values for common HTTP status codes, plus
 * `HttpApiSchemaError` for request decoding failures raised by the HTTP API runtime. The status
 * errors can be used in endpoint or middleware error declarations and are understood by builders,
 * generated clients, reflection, and OpenAPI generation.
 *
 * @since 4.0.0
 */
...
/**
 * Built-in HTTP API error for a `400 Bad Request` response. When used directly as a server
 * response, it renders as an empty response with status 400.
 *
 * @since 4.0.0
 * @category Errors
 */
...
/**
 * No-content schema variant for `BadRequest`, decoding an empty 400 response into a `BadRequest`
 * error value.
 *
 * @since 4.0.0
...
/**
 * Built-in HTTP API error for a `401 Unauthorized` response. When used directly as a server
 * response, it renders as an empty response with status 401.
 *
 * @since 4.0.0
 * @category Errors
 */
...
/**
 * No-content schema variant for `Unauthorized`, decoding an empty 401 response into an
...
/**
 * Built-in HTTP API error for a `403 Forbidden` response. When used directly as a server response,
 * it renders as an empty response with status 403.
 *
 * @since 4.0.0
 * @category Errors
 */
...
/**
 * No-content schema variant for `Forbidden`, decoding an empty 403 response into a `Forbidden`
 * error value.
 *
 * @since 4.0.0
 * @category NoContent errors
...
/**
 * Built-in HTTP API error for a `404 Not Found` response. When used directly as a server response,
 * it renders as an empty response with status 404.
 *
 * @since 4.0.0
 * @category Errors
 */
...
/**
 * No-content schema variant for `NotFound`, decoding an empty 404 response into a `NotFound` error
 * value.
 *
 * @since 4.0.0
 * @category NoContent errors
...
/**
 * Built-in HTTP API error for a `405 Method Not Allowed` response. When used directly as a server
 * response, it renders as an empty response with status 405.
 *
 * @since 4.0.0
 * @category Errors
 */
...
/**
 * No-content schema variant for `MethodNotAllowed`, decoding an empty 405 response into a
...
/**
 * Built-in HTTP API error for a `406 Not Acceptable` response. When used directly as a server
 * response, it renders as an empty response with status 406.
 *
 * @since 4.0.0
 * @category Errors
 */
...
/**
 * No-content schema variant for `NotAcceptable`, decoding an empty 406 response into a
 * `NotAcceptable` error value.
 *
 * @since 4.0.0
 * @category NoContent errors
 */
...
/**
 * Built-in HTTP API error for a `408 Request Timeout` response. When used directly as a server
 * response, it renders as an empty response with status 408.
 *
 * @since 4.0.0
 * @category Errors
 */
...
/**
 * No-content schema variant for `RequestTimeout`, decoding an empty 408 response into a
 * `RequestTimeout` error value.
 *
 * @since 4.0.0
 * @category NoContent errors
 */
...
/**
 * Built-in HTTP API error for a `409 Conflict` response. When used directly as a server response,
 * it renders as an empty response with status 409.
 *
 * @since 4.0.0
 * @category Errors
 */
...
/**
 * No-content schema variant for `Conflict`, decoding an empty 409 response into a `Conflict` error
 * value.
 *
 * @since 4.0.0
 * @category NoContent errors
...
/**
 * Built-in HTTP API error for a `410 Gone` response. When used directly as a server response, it
 * renders as an empty response with status 410.
 *
 * @since 4.0.0
 * @category Errors
 */
...
/**
 * Built-in HTTP API error for a `422 Unprocessable Entity` response. When used directly as a server
 * response, it renders as an empty response with status 422.
 *
 * @since 4.0.0
 * @category Errors
 */
...
/**
 * No-content schema variant for `UnprocessableEntity`, decoding an empty 422 response into an
 * `UnprocessableEntity` error value.
 *
 * @since 4.0.0
 * @category NoContent errors
 */
export const UnprocessableEntityNoContent = UnprocessableEntity.pipe(
  HttpApiSchema.asNoContent({
...
/**
 * Built-in HTTP API error for a `500 Internal Server Error` response. When used directly as a
 * server response, it renders as an empty response with status 500.
 *
 * @since 4.0.0
 * @category Errors
 */
...
/**
 * No-content schema variant for `InternalServerError`, decoding an empty 500 response into an
...
/**
 * Built-in HTTP API error for a `501 Not Implemented` response. When used directly as a server
 * response, it renders as an empty response with status 501.
 *
 * @since 4.0.0
 * @category Errors
 */
...
/**
 * No-content schema variant for `NotImplemented`, decoding an empty 501 response into a
 * `NotImplemented` error value.
 *
 * @since 4.0.0
 * @category NoContent errors
 */
...
/**
 * Built-in HTTP API error for a `503 Service Unavailable` response. When used directly as a server
 * response, it renders as an empty response with status 503.
 *
 * @since 4.0.0
 * @category Errors
 */
...
/**
 * No-content schema variant for `ServiceUnavailable`, decoding an empty 503 response into a
 * `ServiceUnavailable` error value.
 *
 * @since 4.0.0
 * @category NoContent errors
 */
...
/**
 * Error raised when an HTTP API request component fails schema decoding. It records which component
 * failed and responds as an empty `400 Bad Request` when rendered as a server response.
 *
 * @since 4.0.0
 * @category Errors
 */
