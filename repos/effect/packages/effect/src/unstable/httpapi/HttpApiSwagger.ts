 ...
 *
 * This module mounts a browser-based Swagger UI route on an `HttpRouter`. The page renders the
 * OpenAPI document derived from the supplied `HttpApi`, so a running application can expose
 * interactive API documentation without writing a separate OpenAPI file.
 *
 * @since 4.0.0
 */
...
/**
 * Mounts Swagger UI for an `HttpApi` at the configured path, defaulting to `/docs`, using the
 * OpenAPI specification generated from the API.
 *
 * @since 4.0.0
 * @category Layers
 */
