 ...
 *
 * The generator reads API groups, endpoints, schemas, security definitions, and annotations, then
 * produces an OpenAPI document. This module also provides the annotations used to shape that output
 * and the TypeScript model for the OpenAPI objects it generates.
 *
 * @since 4.0.0
 */
...
/**
 * OpenAPI annotation for setting generated descriptions on APIs, groups, endpoints, or security
 * schemes.
 *
 * @since 4.0.0
 * @category Annotations
...
/**
 * OpenAPI annotation for setting the format metadata, such as a bearer token format on security
 * schemes.
 *
 * @since 4.0.0
 * @category Annotations
 ...
 * **When to use**
 *
 * Use to hide internal, experimental, or otherwise undocumented HTTP API groups and endpoints from
...
/**
 * This function checks if a given tag exists within the provided context. If the tag is present, it
 * retrieves the associated value and applies the given callback function to it. If the tag is not
 ...
 * **Details**
 *
 * This function takes an `HttpApi` instance, which defines a structured API, and generates an
 * OpenAPI Specification (`OpenAPISpec`). The resulting spec adheres to the OpenAPI 3.1.0 standard
 * and includes detailed metadata such as paths, operations, security schemes, and components. The
 * function processes the API's annotations, middleware, groups, and endpoints to build a complete
 * and accurate representation of the API in OpenAPI format.
 *
 * The function also deduplicates schemas, applies transformations, and integrates annotations like
 * descriptions, summaries, external documentation, and overrides. Cached results are used for
 * better performance when the same `HttpApi` instance is processed multiple times.
 *
 * @since 4.0.0
...
/**
 * This model describes the OpenAPI specification (version 3.1.0) returned by {@link fromApi}. It is
 * not intended to describe the entire OpenAPI specification, only the output of `fromApi`.
 *
 * @since 4.0.0
 * @category Models
 */
