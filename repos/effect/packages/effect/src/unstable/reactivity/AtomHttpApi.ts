 ...
 * helpers. Query atoms call endpoints and track their asynchronous result, while mutations run
 * endpoint calls that can invalidate reactivity keys after a successful request. Query atoms can
 * also be cached, serialized for hydration, and kept alive with a time-to-live.
 *
 * @since 4.0.0
 */
 ...
 * **Details**
 *
 * It exposes the generated HTTP API client, an atom runtime, mutation helpers that return
 * `AtomResultFn`s, and query helpers that return atoms of endpoint results.
 *
 * @since 4.0.0
 * @category Models
 */
...
/**
 * Creates a `Context.Service` class for an HTTP API client backed by an atom runtime.
 *
 * **Details**
 *
 * The options provide the API definition, HTTP client layer, optional client and response
 * transforms, base URL, and runtime factory used by the query and mutation helpers.
 *
 * @since 4.0.0
