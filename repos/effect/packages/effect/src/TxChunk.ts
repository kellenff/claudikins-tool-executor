 ...
 *
 * A `TxChunk<A>` keeps its current `Chunk<A>` in a `TxRef`, so reads and updates can be committed
 * atomically with other transactional operations. This module offers a transactional version of
 * common chunk workflows, including creating collections, reading or replacing the current chunk,
 ...
 * **Details**
 *
 * This function mutates the original TxChunk by keeping only the elements in the specified range.
 * It does not return a new TxChunk reference.
 *
 ...
 * **Details**
 *
 * This function mutates the original TxChunk by removing elements that don't match the predicate.
 * It does not return a new TxChunk reference.
 *
 ...
 * **Details**
 *
 * This function mutates the original TxChunk by appending all elements from the other chunk. It
