 ...
 * **Details**
 *
 * The `issue` field contains a structured {@link Issue} tree describing every validation failure,
 * including the path to the problematic value, expected types, and actual values received.
 * `message` renders the issue tree as a human-readable string.
 *
