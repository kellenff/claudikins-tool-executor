 ...
 *
 * This module centralizes the small transformations used while rendering generated TypeScript,
 * including operation-name normalization, optional description handling, safe JSDoc comment
 * emission, and direct array merging for code-generation accumulators.
 *
 * @since 4.0.0
 */
 ...
 * **Details**
 *
 * Separators are removed, leading digits are ignored, and letters following a separator or digit
 * are upper-cased without otherwise changing letter casing.
 *
 * @since 4.0.0
 * @category Converting
 */
...
/**
 * Converts an OpenAPI operation id into the exported operation identifier used by generated
 * TypeScript modules.
 *
 * @since 4.0.0
 * @category Converting
 ...
 * **Details**
 *
 * Returns an empty string when the description is absent and escapes any closing comment marker so
 * generated source remains syntactically valid.
 *
 * @since 4.0.0
 * @category Converting
 */
 ...
 * **Details**
 *
 * This mutates `destination` directly, which avoids allocating an intermediate array when generator
 * code needs to merge collections.
 *
 * @since 4.0.0
