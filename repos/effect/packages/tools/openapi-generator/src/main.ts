/**
 * Command-line entry point for generating Effect HTTP clients or HttpApi definitions from an
 * OpenAPI specification.
 *
 * The CLI reads a spec file, optionally applies JSON patches in order, selects the generator layer
 * for the requested output format, reports generation warnings to stderr, and writes the generated
 * source to stdout.
 *
 * @since 4.0.0
 */
 ...
 * **Details**
 *
 * The command reads an OpenAPI specification, optionally applies JSON patches, generates source
 * code in the selected format, writes any generation warnings to stderr, and prints the generated
 * source to stdout.
 *
 * @since 4.0.0
 * @category Running
