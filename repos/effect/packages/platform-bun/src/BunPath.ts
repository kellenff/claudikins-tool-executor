 ...
 *
 * This module provides the `Path` service for Bun programs by reusing the shared Node-compatible
 * path implementation. Provide one of these layers when Bun code should receive path operations
 * from the Effect environment instead of importing runtime path helpers directly.
 *
 * @since 4.0.0
 */
