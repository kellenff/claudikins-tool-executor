 ...
 *
 * This module re-exports the shared Node socket constructors for TCP clients, Unix domain socket
 * clients, and adapters from existing Node `Duplex` streams. It also provides Bun WebSocket layers
 * using `globalThis.WebSocket`, including a constructor layer and a `Socket.Socket` layer for a
 * WebSocket URL.
 *
 * @since 4.0.0
 */
...
/**
 * Creates a `Socket.Socket` layer for a WebSocket URL using Bun's global `WebSocket` constructor,
